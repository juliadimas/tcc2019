...
import br.edu.devmedia.tccdepressionmvp.R;
import model.Link;
...
public class ListViewItemCheckboxBaseAdapter extends BaseAdapter {
    ...
    private List<ListViewItemDTO> listViewItemDtoList = null;
        ...
        public ListViewItemCheckboxBaseAdapter(Context ctx, List<ListViewItemDTO> listLink) {
            this.ctx = ctx;
            this.listViewItemDtoList = listLink;
        }
